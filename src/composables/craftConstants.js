...
export const METALS = [
{
  ...
  calc(target, sel, bon={}, tools={}, t=(k)=>k) {
    ...
    const tree = [
      ...
      ...(coalBonus>1e-6?[{name:t('tree.bonusArrowExtra',{item:'Coal',source:'Calx'}), cls:'base-easy', amount:coalBonus, prefix:'   │     ', tag:'easy', tagLabel:'bonus'}]:[]),
      {divider:true},
      // ── totals
      ...
      ...(netCoal>1e-6?[{name:t('tree.itemExtra',{item:'Coal'}), cls:'base-ore',  amount:netCoal,      prefix:'', tag:'mine', tagLabel:'byproduct'}]:[]),
...
},
{
  ...
  calc(target, sel, bon={}, tools={}, t=(k)=>k) {
    ...
    const tree=[
      ...
      ...(coalBonus>1e-6?[{name:t('tree.bonusArrowExtra',{item:'Coal',source:'Calx'}),cls:'base-easy',amount:coalBonus,prefix:'',tag:'easy',tagLabel:'bonus'}]:[]),
      ...(netCoal>1e-6?[{name:'Coal',cls:'base-ore',amount:netCoal,prefix:'',tag:'mine',tagLabel:'byproduct'}]:[]),
      ...(needBor>0?[{name:'Bor',cls:'base-hard',amount:needBor,prefix:'',tag:'hard',tagLabel:'hard'}]:[]),
      ...(needSulfur>0?[{name:'Sulfur',cls:'base-buy',amount:needSulfur,prefix:'',tag:'buy',tagLabel:'purchase'}]:[]),
      ...(needWater>0?[{name:'Water',cls:'base-easy',amount:needWater,prefix:'',tag:'easy',tagLabel:'easy'}]:[]),
    ];
...
},
{
  ...
  calc(target, sel, bon={}, tools={}, t=(k)=>k) {
    ...
    const tree = [
      ...
      ...(sabPBonus>1e-6?[{name:t('tree.bonusParen',{item:'Saburra Powder'}), cls:'base-easy', amount:sabPBonus, prefix:'   ', tag:'easy', tagLabel:'bonus'}]:[]),
      ...
      ...(malSabBonus>1e-6?[{name:t('tree.bonusParen',{item:'Malachite'}), cls:'base-easy', amount:malSabBonus, prefix:'      ', tag:'easy', tagLabel:'bonus'}]:[]),
      ...
      ...(cpBonus>1e-6?[{name:t('tree.bonusParen',{item:'Calx Powder'}), cls:'base-easy', amount:cpBonus, prefix:'', tag:'easy', tagLabel:'bonus'}]:[]),
      ...(coalBonus>1e-6?[{name:t('tree.bonusArrowExtra',{item:'Coal',source:'Calx'}), cls:'base-easy', amount:coalBonus, prefix:'', tag:'easy', tagLabel:'bonus'}]:[]),
      ...(netCoal>1e-6?[{name:t('tree.itemExtra',{item:'Coal'}), cls:'base-ore', amount:netCoal, prefix:'', tag:'mine', tagLabel:'byproduct'}]:[]),
      ...(needBor>0?[{name:'Bor',         cls:'base-hard',amount:needBor,       prefix:'', tag:'hard', tagLabel:'hard'}]:[]),
